// ============================================================
// PORTÃO - NOTIFICAÇÕES DE ABERTURA E FECHO
// ============================================================
// Shelly 1 Gen4 + Plus Add-on
// Sensor: input:100
// Firmware: 2.0.0
//
...
// ============================================================
// MONITORIZAR INPUT:100
// ============================================================

Shelly.addStatusHandler(function (event) {

    if (event.component !== "input:100") {
        return;
    }
    ...
    if (event.delta && event.delta.state === true) {
    ...
    else if (event.delta && event.delta.state === false) {
